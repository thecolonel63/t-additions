...
import static com.thecolonel63.tadditions.command.helpers.StringHelper.isHexadecimalUUID;
import static com.thecolonel63.tadditions.command.helpers.StringHelper.isIntArrayUUID;
        ...
        ClientCommandManager.DISPATCHER.register(ClientCommandManager.literal("tuuid")
                ...
                .then(ClientCommandManager.literal("convert")
                        .then(ClientCommandManager.argument("UUID", greedyString())
                                ...
                                .executes(context -> {
                                            MinecraftClient MC = MinecraftClient.getInstance();
                                            String UUID = context.getArgument("UUID", String.class).replace(" ","");
